...
public class TransactionService {
    ...
    public Income createIncome(Income income) {
        ...
        clientRepository.findById(income.getClientId())
            .orElseThrow(() -> new EntityNotFoundException("Client not found with ID: " + income.getClientId()));
    ...
    public Expense createExpense(Expense expense) {
        ...
        supplierRepository.findById(expense.getSupplierId())
            .orElseThrow(() -> new EntityNotFoundException("Supplier not found with ID: " + expense.getSupplierId()));
