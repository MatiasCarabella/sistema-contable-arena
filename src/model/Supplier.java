...
/**
 * Represents a supplier in the accounting system.
 * Suppliers are associated with expense transactions.
 */
public class Supplier {
    ...
    public String toString() {
        return String.format("Supplier{id=%d, name='%s', cuit='%s', phone='%s'}", 
            id, name, cuit, phone);
    }
}
